      ...
      <div class="card mb-30 appointment_manage">
        <div class="card-body">
          ...
          <div class="add_service_form">
            ...
            @endif
            <form class="" method="post" action="{{ route('admin.updateQuiz') }}"  enctype="multipart/form-data">
                @csrf
                <input type="text" hidden name="qid" id="qid" value="{{ $quiz[0]['id'] }}">
              <div class="form-group">
                <label class="form-label">Quiz Title</label>
                <input type="text" class="form-control" 
                    name="Quiz_Title" id="Quiz_Title" 
                    value="{{ $quiz[0]['Quiz_Title'] }}" required
                > 
                @error('Quiz_Title')
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" 
                    ...
                    value="{{ $quiz[0]['Quiz_Sub_Title'] }}" required
                > 
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="Status"  id="Status">                 
                  <option value="1" {{ ($quiz[0]['Status']==1)?'selected':'' }}>Active</option>
                  <option value="0" {{ ($quiz[0]['Status']==0)?'selected':'' }}>Inactive</option>
                </select>
                @error('Status')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
