          ...
          <div class="tabs-style-two">
              ...
              <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                      ...
                      <a class="nav-link active" href="/admin-support-categories">Categories</a>
              ...
              <div class="card-body">
                  ...
                  <div class="card-header">
                      ...
                      <span class="add_new">
                          ...
                          <button type="button" class="btn btn-primary add_btn" onclick="window.location.href='/admin-add-support-categories'"><span class="add_icon"><i class="fa fa-plus" aria-hidden="true"></i></span> Add New</button>
                  ...
                  <div class="table-responsive">
                      ...
                      <table class="table m-0 table-striped light table-hover" id="myTable">
                          ...
                          <tbody>
                              ...
                              <?php if(@$categories){ $i=1; foreach(@$categories as $key=>$value){ ?>
                              ...
                              <tr id="user_<?php echo @$value['id'];?>">
                                  ...
                                  <td class="text-center">                                    
                                      ...
                                      <button type="button" title="edit" class="btn btn-link edit_btn p-0 mr-1" onclick="window.location.href='admin/add_category/<?php echo base64_encode(@$value["id"]);?>'">
...
<script type="text/javascript">
...

    {
...

      {
        ...
        var title_m = "Do you want to activate this category ?";
...

      {
        ...
        var title_m = "Do you want to inactivate this category ?";
                    ...
                    deleteUser: {
                        ...
                        action: function () {                            
                            ...
                            $.ajax({                
                                ...
                                url: "/admin/changeStatus/categories",
