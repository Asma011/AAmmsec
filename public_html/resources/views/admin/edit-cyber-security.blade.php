...
<div class="main-content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="admin/cloud_services">Cyber Security</a>
      </li>
    </ol>
  </div>
          ...
          <div class="add_service_form">
            <form class="" id="genres" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" name="data[name]" class="form-control ckeditor" value="<?php echo @$value['name'];?>" >
                <input type="hidden" class="form-control" name="id" value="<?php echo @$value['id'];?>">
                <input type="hidden" class="form-control" name="table" value="cyber_security">
              </div>
              <div class="form-group">
          ...
          $.ajax({
            ...
            success: function(result){
              ...
              if(obj.status == 'success'){
                ...
                setTimeout(function(){
                  window.location.href="admin/cyber_security";
                }, 3000);
              }
