      ...
      <div class="card mb-30 appointment_manage">
        <div class="card-body">
          ...
          <div class="add_service_form">
            ...
            @endif
            <form class=""  method="post" action="{{ route('admin.updateSubPage') }}" enctype="multipart/form-data">
            @csrf
            <input type="text" hidden id="spid" name="spid" value="{{ $subpages[0]['id'] }}">
            <div class="form-group">
                <label class="form-label">Sub Page Of</label>
                <select class="form-control" name="page_id"  id="page_id">
                   
                    @foreach ($pages as $page )
                      <option value="{{ $page->id }}" {{ ($page->id==$subpages[0]['page_id'])?'selected':'' }} >{{ $page->page_title }}</option>                    
                    @endforeach                   
                </select>
            </div>
            
              <div class="form-group">
                <label class="form-label">Sub Page Title</label>
                <input type="text" class="form-control" name="sub_page_title" id="sub_page_title"
                 value="{{ $subpages[0]['sub_page_title'] }}" required >
                 @error('page_title')
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="banner_title" id="banner_title"
                 value="{{ $subpages[0]['banner_title'] }}" required >
                 @error('banner_title')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="banner_sub_title" id="banner_sub_title"
                 value="{{  $subpages[0]['banner_sub_title'] }}" required >
              ...
              <div class="form-group">
                ...
                <img src="{{ asset('assets/uploads/banners/'.$subpages[0]['banner_img_location'])  }}" 
                 height="100px" width="100px" alt="banimg">
              ...
              <div class="form-group">
                ...
                cols="20" rows="8" >{{ $subpages[0]['Section_Content1'] }}</textarea>               
                 @error('editor1')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                cols="20" rows="8" >{{ $subpages[0]['Section_Content2'] }}</textarea>               
                 @error('editor2')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                cols="20" rows="8" >{{ $subpages[0]['Section_Content3'] }}</textarea>               
                 @error('editor3')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="slug" id="slug" value="{{ $subpages[0]['slug'] }}"
                  required >
                 @error('slug')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="status"  id="status">
                  <option value="1" {{ ($subpages[0]['status']==1)?'selected':'' }}>Active</option>
                  <option value="0" {{ ($subpages[0]['status']==0)?'selected':'' }}>Inactive</option>
                </select>
              </div>
