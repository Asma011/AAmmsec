...
<div class="main-content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="admin/it_services">Cyber Security</a>
      </li>
    </ol>
  </div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table m-0 table-striped light table-hover" id="myTable">
              ...
              <tbody>
                <?php if(@$cyber_security){ $i=1; foreach(@$cyber_security as $key=>$value){ ?>
                  <tr id="user_<?php echo @$value['id'];?>">
                    ...
                    <td class="text-center">
                      <button type="button" title="edit" class="btn btn-link edit_btn p-0 mr-1" onclick="window.location.href='admin/edit_cyber_security/<?php echo base64_encode(@$value["id"]);?>'">
