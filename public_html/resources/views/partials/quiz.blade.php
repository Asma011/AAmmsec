...
<section style="background: #ebeaea;"">
<div class='container' >
  <div class="row" >
...
function getQuizstarted(questions){
  ...
  function displayScore() {
    ...
    score.append('Please Fill Details to Proceed');
    return score;
  }
  function displayScore2(corr_count, total_count) {
    ...
    '<input type="hidden"  id="total_que" value="'+total_count+'" name="total_que"/>'+
    '<input type="hidden"  id="correct_count" value="'+corr_count+'" name="correct_count"/>');
    qElement.append(question);
